...
const components = [
  ...
  {
    name: 'Spinner',
    import: "import { Spinner } from '@cathode-ui/react';",
    summary: 'Indeterminate loading indicator — pixel-square segments cycling via CSS. Use when duration is unknown.',
    props: [
      { name: 'size',   type: "'sm'|'md'|'lg'",                                required: false, default: 'md' },
      { name: 'accent', type: "'info'|'success'|'warning'|'danger'|'accent'", required: false, default: 'info' },
    ],
    ...
    feedback: { haptic: null, sound: null },
    examples: [{ name: 'loading', snippet: '<Spinner /> <span>CONNECTING…</span>' }],
  },
  {
    name: 'Skeleton',
